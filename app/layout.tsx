...
export default function Home() {
  ...
  // Handle paste images (Ctrl+V) - Show preview, don't send immediately
  useEffect(() => {
  ...
  const sendMessage = () => {
    ...
    const newMessage: any = { role: "user", content: input || "Image" };
            ...
            {imagePreview && (
              <div className="mb-3 relative inline-block">
                ...
                <button
                  ...
                  className="absolute -top-2 -right-2 w-6 h-6 bg-red-600 rounded-full flex items-center justify-center text-white text-xs hover:bg-red-700"
                >
                  ✕
                </button>
              </div>
